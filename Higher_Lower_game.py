...
def follower():
    if first_data['follower_count'] > second_data['follower_count']:
        str1 = 'A'
        list.append(first_data)
        return str1
    else:
        str2 = 'B'
        list.append(second_data)
        return str2


def higher(score, list):
    print(logo)
    score += 1
    print(f"You're right! Current score: {score}.")
    print(f"Compare A: {list[0]['name']}, a {list[0]['description']}, from {list[0]['country']}.")
    print(vs)
...
print(f"Against B: {second_data['name']}, a {second_data['description']}, from {second_data['country']}.")
while flag is True:
    followers = input("Who has more followers? Type 'A' or 'B': ").capitalize()
    result = follower()
    if result == followers:
        score = higher(score, list)
    else:
